...
default_alphabet = "arch bat cap drum each fine gust harp ice jury crunch look made near orange pit quench red sun trap urge vest whale plex yank zone".split(
    " "
)
